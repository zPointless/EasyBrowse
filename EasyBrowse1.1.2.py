...
easygui.msgbox('This is the web browser EasyBrowse PRO. Please do not copy without permission from the owner of this project.', 'EasyBrowse Applications, PRO')
print('\033c')
name = easygui.enterbox('Before you start, we would like to know your name. This will be used for your browser notifications.', title = 'EasyBrowse Applications, PRO')
print('\033c')
if name == None or name == '':
	name = 'EasyBrowse User %s' % random.randint(100000, 999999)
defaultsite = easygui.enterbox('Default Site:', 'EasyBrowse Applications, PRO')
print('\033c')
primary_search = easygui.enterbox('Primary Search:', 'EasyBrowse Applications, PRO')
print('\033c')
if primary_search == None:
	primary_search = 'google.com'
easygui.msgbox('You\'re all set to go!', 'EasyBrowse Applications: PRO')

#variables
def variable_keep(index, title, url):
	default_site = defaultsite    #set default site. template: 'https://greatsite.com'
	primarysearch = primary_search    #primary search site. template : 'bestsearch.com'
...
easygui.msgbox('Thanks for using EasyBrowse PRO, %s!' % name, 'EasyBrowse Applications, PRO')
